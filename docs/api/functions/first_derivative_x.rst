...
.. py:function:: first_derivative_x(fs, mode="fdiff",  poles_missing_values=False)
   ...
   * the computations are performed by using :func:`regrid` with the nabla="scalar_gradient" option to compute the gradient and taking the zonal component of it 
