...
.. describe:: fieldset poly_mask (fs, fieldset, vector, vector, [string] )
.. describe:: fieldset poly_mask (fs, fieldset, list, list, [string] )

   *New in Metview version 5.16.0*.

   For each field of the input fieldset creates a field containing 0 or 1 values according to whether a grid point
